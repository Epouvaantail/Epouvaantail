...
<p>Diplômé en développement web je suis basé dans le sud de la France et mobile sur tout le territoire national. À la recherche d’un contrat d’alternance Concepteur développeur d’applications .Net (Bac +3/4). Ma stack actuel est React/Redux en Front, NodeJS/ExpressJS en Back et MongoDB en Base de données.</p>
